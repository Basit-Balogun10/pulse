...
**Use Vercel AI SDK streaming** — the alert text streams in word by word, live, in real time. This is the moment that lands with judges.
...
### AI integration
- [ ] Vercel AI SDK set up with chosen model (GPT-4o or Claude)
